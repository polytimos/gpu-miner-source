...
#define PACKAGE_BUGREPORT "veox@wemakethings.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "sgminer"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "sgminer 5.3.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sgminer"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/tpruvot/sgminer"
...
/* Major version */
#define SGMINER_MAJOR_VERSION 5

/* Micro version */
#define SGMINER_MINOR_SUBVERSION 3

/* Minor version */
#define SGMINER_MINOR_VERSION 3

/* Path to sgminer install */
#define SGMINER_PREFIX "/usr/local/bin"

/* Revison */
#define SGMINER_REVISON 0
